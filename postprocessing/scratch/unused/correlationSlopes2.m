    ...
    for dtiIndex = 1:length(dtiList)
        try
            ...
            if any(ismember(fmriSubjIDList, dtiSubjID))
                ...
                slope_neg = dtifmriStrength2(dtiSubj, fmriSubj, -1.0, -0.35);
                slope_null = dtifmriStrength2(dtiSubj, fmriSubj, -0.35, 0.35);
                slope_pos = dtifmriStrength2(dtiSubj, fmriSubj, 0.35, 1.0);
