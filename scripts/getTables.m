...
csvwrite('/scratch/lliu/SPINS/analysis/tables/slopes_ctrl_length_weighted.csv', getSlopes(length_weighted_control_arm_1, fmri_control_arm_1))
csvwrite('/scratch/lliu/SPINS/analysis/tables/slopes_ctrl_volume_weighted.csv', getSlopes(connectivity_weighted_control_arm_1, fmri_control_arm_1))
...
csvwrite('/scratch/lliu/SPINS/analysis/tables/slopes_case_length_weighted.csv', getSlopes(length_weighted_case_arm_2, fmri_case_arm_2))
csvwrite('/scratch/lliu/SPINS/analysis/tables/slopes_case_volume_weighted.csv', getSlopes(connectivity_weighted_case_arm_2, fmri_case_arm_2))
